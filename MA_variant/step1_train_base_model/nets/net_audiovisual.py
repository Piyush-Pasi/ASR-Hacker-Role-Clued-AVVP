    ...
    def forward(self, src_a, src_v, mask=None, src_key_padding_mask=None):
        ...
        for i in range(self.num_layers):
            output_a = self.layers[i](src_a, src_v, src_mask=mask,
                                    src_key_padding_mask=src_key_padding_mask, cross_attn=True)
            output_v = self.layers[i](src_v, src_a, src_mask=mask,
                                      src_key_padding_mask=src_key_padding_mask, cross_attn=False)
...
class HANLayer(nn.Module):
    ...
    def forward(self, src_q, src_v, src_mask=None, src_key_padding_mask=None, cross_attn=True):
